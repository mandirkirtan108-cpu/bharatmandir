...
import { Search, Menu, X, Navigation, CalendarDays, BookOpen, PenLine, User, LogOut, Landmark } from 'lucide-react';
      ...
      <aside ref={sidebarRef} className={`sidebar${sidebarOpen ? ' sidebar-open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
          >
            <span className="sidebar-link-icon"><Landmark size={16} /></span>
            Feedback
          </Link>
