...
import { ArrowLeft, BookOpen, FileUp, Loader2, Trash2 } from 'lucide-react';
      ...
      <div className="admin-library-grid">
        ...
        <section className="processing-card">
          ...
          {books.map(book => <div className="admin-book" key={book.id}>
            <div><strong>{book.title}</strong><small>{book.original_filename}</small></div>
