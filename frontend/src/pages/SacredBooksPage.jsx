...
export default function SacredBooksPage() {
  ...
  return <>
    ...
    <main className="library">
      <section className="library-hero">
        <div className="library-hero-inner">
          <div className="library-badge"><BookOpen size={11} /> Digital scripture library</div>
          <h1>A quiet place to read the scriptures</h1>
          <p>Every page kept exactly as it was written — Sanskrit, Hindi, English, and the original, side by side. Open a book, not a webpage.</p>
          <div className="library-blessing">सुस्वागतम् — welcome, devotee</div>
        </div>
    ...
    <style>{`
      ...
      /* Hero — resized to match the AI Guide page hero: padding:50px 12px,
         inner max-width 700, badge/title/subtitle sizes all aligned so the
         two pages read as the same banner height across the site. */
      .library-hero{
        position:relative;overflow:hidden;
        width:100vw;margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw);
        background:
      ...
      .library-hero-inner{
        ...
        padding:0 24px;box-sizing:border-box;text-align:center;color:#f1dcb8;
      }
      .library-badge{
        display:inline-flex;gap:8px;align-items:center;padding:5px 16px;
        border:1px solid #c9932f60;border-radius:50px;color:#e9c795;
      ...
      .library-hero h1{
        ...
        font-size:clamp(28px,5vw,52px);line-height:1.1;margin:14px 0 10px;
        background:linear-gradient(180deg,#f7e2ae,#c9932f);-webkit-background-clip:text;
        background-clip:text;color:transparent;
      }
      .library-hero p{
        opacity:.85;font-size:14px;font-family:'Crimson Pro',serif;
        margin:0 auto;max-width:520px;line-height:1.7;
      }
      .library-blessing{margin-top:14px;font-family:var(--font-hindi,'Noto Serif Devanagari'),serif;font-size:15px;color:#e9c795cc;letter-spacing:.02em}

      .library-content{position:relative;z-index:1;max-width:1160px;margin:auto;padding:0 20px 80px}
      .library-search{
        max-width:520px;margin:36px auto 44px;background:#fffaf0;border:1px solid #dcc7a4;border-radius:14px;
        padding:14px 18px;display:flex;gap:10px;align-items:center;box-shadow:0 12px 30px #5c270b25;color:#7a5230
      }
      .library-search input{border:0;outline:0;width:100%;font-size:15px;background:transparent;font-family:'Crimson Pro',serif;color:#432516}
